...
class _TodoListScreenState extends ConsumerState<TodoListScreen> {
        ...
        children: [
              ...
              return Padding(
                ...
                child: Text(
                  ...
                  ref.watch(todoProvider
                      .select((todo) => "${todo.data?.length ?? "0"}")),
          ...
          PopupMenu<TodoStatus>(
            ...
            onChanged: (TodoStatus status) {
              //  context.read<TodoCubit>().getTodos(widget.user.id!, status: status);
              ref
                  .read<TodoNotifier>(todoProvider.notifier)
  ...
  createOrUpdateTodo(ToDo todo, Mode mode) {
    if (mode == Mode.create) {
      ...
      ref.read(todoProvider.notifier).createTodo(todo);
    } else {
            ...
            case Status.success:
              return ProgressDialog(
                ...
                onPressed: () {
                  ...
                  ref.read(todoProvider.notifier).getTodos(widget.user.id!);
...
//     if (mode == Mode.create) {
//      // context.read<TodoCubit>().createTodo(todo);
//       ref.read(todoProvider.notifier).deleteUser(user);
//
//     } else {
//     //  context.read<TodoCubit>().updateTodo(todo);
//     }
