...
class GenericBlocState<T> {
  ...
  factory GenericBlocState.empty() => const GenericBlocState(status: Status.empty);
  ...
  factory GenericBlocState.success(List<T>? data) => GenericBlocState(data: data, status: Status.success);
}
